...
-- Évaluer la qualité du générateur aléatoire et les HT.

procedure Evaluer_Alea_HT is
   
   function id(N : in Integer) return Integer is
   begin
      return N;
   end id;
   ...
   is
      ...
      procedure Min_Max is new Pour_Chaque_HT(Verfier_Min_Max);
