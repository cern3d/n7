...
procedure TesT_HT is
	...
	-- Utiliser & entre String à gaCapacity => 11, T_Cle => Unbounded_String, T_Valeur => Integer, Hachage => Length);uche et Unbounded_String à droite.  Des
	...
	procedure Construire_Exemple_Sujet (Annuaire : out T_HT; Bavard: Boolean := False) is
	begin
	...
	procedure Tester_Pour_chaque is
		...
		procedure Sommer is            --un TH est vide si tous ses éléments sont vides
			new Pour_Chaque_HT (Sommer);
	...
	procedure Tester_Pour_chaque_Somme_Si_Cle_Commence_Par_Q is
		...
		procedure Sommer is
			new Pour_Chaque_HT (Sommer_Cle_Commence_Par_Q);
	...
	procedure Tester_Pour_chaque_Somme_Len4_Avec_Exception is
		...
		procedure Sommer is
			new Pour_Chaque_HT (Sommer_Len4_Avec_Exception);
